          ...
          body: Stack(
            ...
            children: [
              Container(
                  ...
                  padding:
                      EdgeInsets.only(left: 20.sp, right: 20.sp, top: 12.sp),
                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                searchResultItem(
                                    "Self paced", courseItems.sublist(0, 2)),
                                ...
                                searchResultItem(
                                    "Classroom", courseItems.sublist(0, 2)),
                                SizedBox(
                                  height: 8.sp,
                                ),
                                Divider(
                      ...
                      child: Column(
                        children: [
                          ...searchController.text.isNotEmpty
                              ...
                              : [...recentSearch].map((item) => GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      searchController.text = item;
                                      isSearchCompleted = true;
