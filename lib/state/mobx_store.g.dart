...
mixin _$ZStore on _ZStore, Store {
  ...
  late final _$_ZStoreActionController =
      ActionController(name: '_ZStore', context: context);

  @override
  void setUserDetails(UserDetailsModel userDetails) {
    final _$actionInfo =
        _$_ZStoreActionController.startAction(name: '_ZStore.setUserDetails');
    try {
      return super.setUserDetails(userDetails);
    } finally {
      _$_ZStoreActionController.endAction(_$actionInfo);
    }
  }
